...
const Versatile = ({ index }) => {
  return (
    <section className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-screen overflow-hidden bg-black">
      {" "}
      <img
      ...
      <button
        ...
        className="absolute bottom-[10%] sm:bottom-[15%] left-[5%] sm:left-[10%] w-[120px] sm:w-[150px] h-[40px] sm:h-[50px] cursor-pointer bg-transparent"
      />{" "}
    </section>
  );
};
